...
public class PractitionerAccountSettings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.account_settings_practitioner);
...
*/
        ...
        CaptureImage.checkPermissions(PractitionerAccountSettings.this, PractitionerAccountSettings.this);
        ...
        saveButton.setOnClickListener(v -> {
            if (validateInputs()) {
                ...
                Toast.makeText(PractitionerAccountSettings.this, "Please fill all fields correctly", Toast.LENGTH_LONG).show();
            }
        });
...
*/
    ...
    private void showImageSourceOptions() {
        AlertDialog.Builder builder = new AlertDialog.Builder(PractitionerAccountSettings.this);

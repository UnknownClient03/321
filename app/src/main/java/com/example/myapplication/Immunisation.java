...
public class Immunisation extends AppCompatActivity {
    ...
    public LoginManager manager; // Assuming LoginManager is used to manage user session

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_immunisation); // Ensure you have an XML layout file named activity_immunisation.xml

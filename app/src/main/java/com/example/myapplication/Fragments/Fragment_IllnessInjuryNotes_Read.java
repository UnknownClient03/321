 ...
 * Use the {@link Fragment_IllnessInjuryNotes_Read#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Fragment_IllnessInjuryNotes_Read extends Fragment {
    ...
    public Fragment_IllnessInjuryNotes_Read() {
     ...
     * @return A new instance of fragment Fragment_IllnessInjuryNotes_Read.
     */
    // TODO: Rename and change types and number of parameters
    public static Fragment_IllnessInjuryNotes_Read newInstance(String param1, String param2) {
        Fragment_IllnessInjuryNotes_Read fragment = new Fragment_IllnessInjuryNotes_Read();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View layout = inflater.inflate(R.layout.fragment__illness_injury_notes__read, container, false);

        Button writeEntryBut = (Button)layout.findViewById(R.id.button_IIN_addAnotherEntry);
        ...
        if(c.isConn())
        {
            ...
            for(int i = 0; i < result.get("date").length; i++)
            {
                ...
                newText1.setText(result.get("problem")[i]);

                TextView newText2 = new TextView(this.getContext());
                newText2.setText(result.get("signed")[i]);
